<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsupplier.aspx.cs" Inherits="企业信息管理.addsupplier" %>
    ...
    <form runat="server">
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <h3 class="card-title">添加供应商</h3>
              <div class="card-body">
                <div class="form-group">
                  <asp:TextBox runat="server" ID="tbSupplierName" CssClass="form-control" />
                </div>
              </div>
              <div class="card-footer">
                <button id="btn_commit" class="btn btn-primary icon-btn" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>添加</button>
                &nbsp;&nbsp;&nbsp;
                <a class="btn btn-default icon-btn" href="suppliers.aspx"><i class="fa fa-fw fa-lg fa-times-circle"></i>取消</a>
                ...
                <script>
                  document.getElementById("btn_commit").addEventListener("click", function () {
                    if ($("#<%=tbSupplierName.ClientID %>").val().length > 0) {
